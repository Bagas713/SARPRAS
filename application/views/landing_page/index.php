...
<html lang="en">
  ...
  <head>
    ...
    <title>Peminjaman Alat Praktikum</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Peminjaman Alat Praktikum</a>
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>Peminjaman Alat Praktikum POLINES</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded">Sarana Peminjaman Alat Praktikum</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Silahkan Pinjam</h2>
            <hr class="light my-4">
      ...
      <div class="container-fluid p-0">
        <div class="row no-gutters popup-gallery">
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="assets/landing_page_assets/img/portfolio/fullsize/crimping.jpg">
              <img class="img-fluid" src="assets/landing_page_assets/img/portfolio/thumbnails/crimping.jpg" alt="">
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="assets/landing_page_assets/img/portfolio/fullsize/toolkitsolder.jpg">
              <img class="img-fluid" src="assets/landing_page_assets/img/portfolio/thumbnails/toolkitsolder.jpg" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
          ...
          <div class="col-lg-4 col-sm-6">
            <a class="portfolio-box" href="assets/landing_page_assets/img/portfolio/fullsize/7.jpg">
              <img class="img-fluid" src="assets/landing_page_assets/img/portfolio/thumbnails/7.jpg" alt="">
              <div class="portfolio-box-caption">
                <div class="portfolio-box-caption-content">
                  <div class="project-category text-faded">
                    Category
    ...
    <section class="bg-dark text-white">
      <div class="container text-center">
        <h2 class="mb-4">Jangan Lupa Habis Pinjam Kembalikan!</h2>
